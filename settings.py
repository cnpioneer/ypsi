...
MANAGERS = ADMINS
DBPATH =  os.path.join(JUST_HERE,'base.db').replace('\\','/')
DATABASES = {
    'default': {
...
MEDIA_ROOT = os.path.join(JUST_HERE,'static/uploads/').replace('\\','/')
...
SECRET_KEY = '!o$6*#h*73tv3w9r!%yn^!z#8$n&nuhglluqdlj+qmf4k^h3&%'
